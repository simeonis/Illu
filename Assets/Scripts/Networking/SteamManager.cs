...
namespace Illu.Steam {
    ...
    {
        // Events
        [SerializeField] private Event OnLobbyCreated;

        // Callbacks
        protected Callback<LobbyCreated_t> steamLobbyCreated;
        protected Callback<GameLobbyJoinRequested_t> steamGameLobbyJoinRequested;
        protected Callback<LobbyEnter_t> steamLobbyEntered;
        protected Callback<LobbyInvite_t> steamLobbyInvited;
        protected Callback<LobbyChatUpdate_t> steamLobbyChatUpdate;
        protected Callback<LobbyChatMsg_t> steamLobbyChatMessage;
        ...
        void Start()
        {
            networkManager = GetComponent<Networking.NetworkManager>();
        ...
        void OnEnable()
        {
            ...
            steamLobbyCreated = Callback<LobbyCreated_t>.Create(OnLobbyCreateAttempt);
            steamGameLobbyJoinRequested = Callback<GameLobbyJoinRequested_t>.Create(OnGameLobbyJoinRequested);
            steamLobbyEntered = Callback<LobbyEnter_t>.Create(OnLobbyJoinAttempt);
            steamLobbyInvited = Callback<LobbyInvite_t>.Create(OnLobbyInvited);
            steamLobbyChatMessage = Callback<LobbyChatMsg_t>.Create(OnLobbyChatMessage);
        ...
        void OnDisable()
        {
            ...
            steamLobbyCreated.Dispose();
            steamGameLobbyJoinRequested.Dispose();
            steamLobbyEntered.Dispose();
            steamLobbyInvited.Dispose();
            steamLobbyChatMessage.Dispose();
