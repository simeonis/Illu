...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] private float xRotation, yRotation;
    ...
    *   -------------------------- */
    ...
    private void Crouch()
    {
        ...
        StartCoroutine(crouchCoroutine = 
            AdjustHeightOverTime(defaultHeight * crouchFactor, timeToCrouch));
    ...
    private void UnCrouch()
    {
        ...
        if (!underCeiling)
        {
            ...
            StartCoroutine(sprintCoroutine = 
                AdjustSpeedOverTime(isSprinting ? sprintSpeed : walkSpeed, timeToSprint));
        }
        // Obstruction
